...
const communityStories = [
  ...
  {
    quote: "My parents are elderly and their dog, Charlie, needs more exercise than they can manage. Neighbors who step in have been a lifesaver — Charlie is thrilled, and my parents feel supported.",
    author: "Jennifer, Family Member"
  },
  {
    quote: "Single mom here — I was overwhelmed trying to juggle work, school, and my two kids. Now my pup gets outside while I prep dinner.",
  ...
  {
    quote: "I was recovering from illness and worried about leaving my dog alone. With help from local dog lovers, he still gets daily playtime and has discovered his love for swimming.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center bg-white rounded-2xl p-8 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Verified Profiles & Reviews</h3>
            ...
            <div className="text-center bg-white rounded-2xl p-8 shadow-lg">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Privacy-First Location Protection</h3>
              <p className="text-gray-700">
