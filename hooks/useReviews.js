...
export const useUserReviews = (userId, showAll = false) => {
  return useQuery({
    ...
    queryFn: async () => {
      if (!userId) return { reviews: [], stats: { averageRating: 0, reviewCount: 0, ratingDistribution: {} } };
      ...
      return {
        ...
        stats: statsResponse.ok ? statsData : { averageRating: 0, reviewCount: 0, ratingDistribution: {} }
      };
    },
    enabled: !!userId,
